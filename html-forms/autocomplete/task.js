class Autocomplete {
  ...
  getMatches( text ) {
    ...
    */
      this.options = Array.from(this.input.getElementsByTagName('option'));
      this.contentOptions = this.options.map(e => {
        return {text: e.textContent, value: e.value};
      }).filter(e => e.text.includes(this.searchInput.value));
